...
def train_model(model, train_loader, loss_fn, optimizer, epochs):
    """
    Train local model (standard training - no proximal term).
    """
    model.train()
            ...
            for cl in n_clients:
                ...
                for comm_round in range(comms_round):
                    ...
                    for client in selected_clients:
                        ...
                        # 4) Calculate Update Norm (Proxy for Gradient Norm)
                        ...
                        # 5) Evaluate on the client's own data to get new Acc
                        ...
                        # 7) Scale & collect for global aggregation
                    ...
                    # 8) Calculate Variance of Updates for this round
