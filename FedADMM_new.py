        ...
        for r in n_round:
            ...
            for cl in n_clients:
                ...
                for comm_round in range(comms_round):
                    # Store global weights at the start of the round to calculate update norms later
                    global_weights_start = [param.data.clone() for param in global_model.parameters()]
                    ...
                    for client in selected_clients:
                        ...
                        local_model.load_state_dict({name: param.clone() for name, param in zip(local_model.state_dict(), global_weights_start)})
                        ...
                        update_norm = compute_weight_norm(local_model.parameters(), global_weights_start)
                        round_update_norms.append(update_norm)

                        # 2. Scale and collect weights
